   ...
   Properties
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                v2f o;
                //changing vertex position over time using sin with speed and amplitude with other vertex position
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // sample the texture
                float4 col = 0;
                //changing blur size over time randomly using random k value
                _BlurSize = sin(_BlurSize*_Time.z*15)*k;
                for(float index = 0; index < 10; index++){
                    //changing uv by adding different values in every iteration and modifying it with _BlurSize property
