Shader "Custom/Hologram1"
{
    Properties
    {
        ...
        _Strength1 ("_Strength1", Range(0,1)) = 0.5
        _Strength2 ("_Strength2", Range(0,1)) = 0.5
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
            ...
            fixed4 t = (_RimColor.y-_Strength2)/(_Strength1-_Strength2);               
            fixed4 mixture =lerp(_RimColor,_CustomColor,t);
            float3 customColor = lerp(_RimColor,_CustomColor,cos(_Time));
            float3 rimEmission = mixture * pow(rim, _RimPower) * 10;
